...
FString USlotTechPanelWidget::ComposeHelpText() const
{
	...
	return FString(
		...
		TEXT("\n")
		TEXT("   THE METERS PAGE   [M]\n")
		TEXT("     Everything above is theory — what the machine SHOULD do. Press M for\n")
		TEXT("     what it actually DID. The two will not match, and learning to read the\n")
		TEXT("     gap between them is the real skill.\n")
		TEXT("\n")
		TEXT("   HARD METERS AND SOFT METERS\n")
		TEXT("     Real cabinets carry both. SOFT meters cover the current session, and an\n")
		TEXT("     attendant clears them on a service call. HARD meters are lifetime\n")
		TEXT("     totals and NOTHING clears them — on a real machine that is the law, and\n")
		TEXT("     it is what makes the number worth anything. Yours cannot be reset\n")
		TEXT("     either. That is not an oversight.\n")
		TEXT("\n")
		TEXT("   COIN IN AND COIN OUT\n")
		TEXT("     What was wagered, and what came back. Free spins add to coin OUT but\n")
		TEXT("     never to coin IN, because they cost nothing — which is exactly how a\n")
		TEXT("     bonus round makes a machine feel generous without changing the price.\n")
		TEXT("\n")
		TEXT("   WHY YOUR SESSION PROVES NOTHING\n")
		TEXT("     A short run on a slot machine is very nearly pure noise. The meters\n")
		TEXT("     page prints the range of returns that count as NORMAL for the number of\n")
		TEXT("     spins you have actually played — and at a few dozen spins that range is\n")
		TEXT("     so wide it is useless, which IS the lesson. Below fifty spins the page\n")
		TEXT("     will not even quote one.\n")
		TEXT("     To measure this machine to within a single percentage point takes a few\n")
		TEXT("     hundred thousand spins. So if your session came in low, that is not\n")
		TEXT("     evidence of anything. Neither is one that came in high.\n")
		TEXT("\n")
		TEXT("   WHAT A REAL FLOOR DOES WITH THIS\n")
		TEXT("     Somebody archives every spin of every machine and reports what each one\n")
		TEXT("     really returned against what its par sheet promised. When a machine\n")
		TEXT("     drifts, the job is deciding whether it is broken or merely unlucky —\n")
		TEXT("     and at these sample sizes the answer is almost always unlucky. Those\n")
		TEXT("     reports are the reason a par sheet is worth writing down: a promise\n")
		TEXT("     nobody ever checks is not a promise.\n"));
}
