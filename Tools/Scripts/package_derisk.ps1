# Package the v0.5.1 Development Win64 RELEASE build to a clean dir.
# Mirror of package_v050.ps1 with the 0.5.1 archive dir + log.
$uat = "C:\Program Files\Epic Games\UE_5.7\Engine\Build\BatchFiles\RunUAT.bat"
$log = "C:\Users\wpark\projects\sibelius-game\pkg-derisk.log"
...
$uatArgs = @(
  ...
  "-archivedirectory=C:\Users\wpark\builds\sibelius-derisk",
