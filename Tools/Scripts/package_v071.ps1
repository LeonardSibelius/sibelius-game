# Package the v0.7.1 Development Win64 RELEASE build (butler -> itch).
...
$log = "C:\Users\wpark\projects\sibelius-game\pkg-v071.log"
...
$uatArgs = @(
  ...
  "-archivedirectory=C:\Users\wpark\builds\sibelius-v0.7.1",
