# Package the v0.9.9.1 SHIPPING Win64 build — "The City".
#
# Content of 0.9.9.1: the game has somewhere to go after it ends. Clear the Refuser army
...
$log     = "$root\pkg-v0991.log"

# The pak we are growing from, so the cost of the city is a number and not a feeling.
$baselinePaks = "C:\Users\wpark\builds\sibelius-v0.9.9.0\Windows\SibeliusGame\Content\Paks"
...
Write-Output ("pak  v0.9.9.1 : {0} GB" -f $new)
