# Package the v0.9.7.5 SHIPPING Win64 build — "Kaia, properly lit".
#
# Content of 0.9.7.5: the game boots into a talking cutscene. Kaia introduces
...
$log = "C:\Users\wpark\projects\sibelius-game\pkg-v0975.log"
...
$uatArgs = @(
  ...
  "-archivedirectory=C:\Users\wpark\builds\sibelius-v0.9.7.5",
