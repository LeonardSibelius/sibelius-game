# Package the v0.8.2 SHIPPING Win64 RELEASE build (butler -> itch).
# Content of 0.8.2: Aisling and Elise, two MetaHuman figures flanking The
...
$log = "C:\Users\wpark\projects\sibelius-game\pkg-v082.log"
...
$uatArgs = @(
  ...
  "-archivedirectory=C:\Users\wpark\builds\sibelius-v0.8.2",
