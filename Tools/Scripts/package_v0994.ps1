# Package the v0.9.9.4 SHIPPING Win64 build — "The City".
#
# Content of 0.9.9.4: the game has somewhere to go after it ends. Clear the Refuser army
...
Write-Output ("pak  v0.9.9.4 : {0} GB" -f $new)
