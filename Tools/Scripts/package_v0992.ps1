# Package the v0.9.9.2 SHIPPING Win64 build — "The City".
#
# Content of 0.9.9.2: the game has somewhere to go after it ends. Clear the Refuser army
...
$log     = "$root\pkg-v0992.log"

# The pak we are growing from, so the cost of the city is a number and not a feeling.
$baselinePaks = "C:\Users\wpark\builds\sibelius-v0.9.9.1\Windows\SibeliusGame\Content\Paks"
...
Write-Output ("pak  v0.9.9.2 : {0} GB" -f $new)
