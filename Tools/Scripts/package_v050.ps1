# Package the v0.5.0 Development Win64 RELEASE build to a clean dir (not travel-test).
$uat = "C:\Program Files\Epic Games\UE_5.7\Engine\Build\BatchFiles\RunUAT.bat"
$log = "C:\Users\wpark\projects\sibelius-game\pkg-v050.log"
...
$uatArgs = @(
  ...
  "-archivedirectory=C:\Users\wpark\builds\sibelius-v0.5.0",
